        ...
        <div className="lg:col-span-1 space-y-8">
          <div className="glass-card p-10 rounded-3xl border border-siyajj-luxury-gold/20 shadow-2xl bg-black/40 backdrop-blur-xl">
            ...
            <div className="space-y-8">
              <a href="tel:+33100000000" className="flex items-center gap-5 group">
                ...
                <div>
                  ...
                  <div className="text-siyajj-ivory font-serif text-xl group-hover:text-siyajj-champagne transition-colors">+33 1 00 00 00 00</div>
                </div>
              </a>
              
              <a href="https://wa.me/33100000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-5 group">
                <div className="w-12 h-12 rounded-full bg-siyajj-luxury-gold/5 border border-siyajj-luxury-gold/30 flex items-center justify-center group-hover:bg-siyajj-luxury-gold/20 transition-all duration-300 shrink-0">
                ...
                <div>
                  ...
                  <div className="text-siyajj-ivory font-serif text-lg group-hover:text-siyajj-champagne transition-colors">Discuter avec un conseiller</div>
                </div>
              </a>
              
              <a href="mailto:contact@siyajj.fr" className="flex items-center gap-5 group">
                <div className="w-12 h-12 rounded-full bg-siyajj-luxury-gold/5 border border-siyajj-luxury-gold/30 flex items-center justify-center group-hover:bg-siyajj-luxury-gold/20 transition-all duration-300 shrink-0">
                ...
                <div>
                  ...
                  <div className="text-siyajj-ivory font-serif text-lg group-hover:text-siyajj-champagne transition-colors">contact@siyajj.fr</div>
                </div>
              </a>
            </div>
          </div>
            ...
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <Input id="contact-nom" placeholder="Votre nom" className="bg-black/50 border-white/10 text-siyajj-ivory h-14 rounded-lg focus-visible:ring-siyajj-luxury-gold/50 focus-visible:border-siyajj-luxury-gold/50 font-light text-lg" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="contact-tel" className="text-[10px] uppercase tracking-widest text-siyajj-luxury-gold ml-1">Téléphone</label>
                  <Input id="contact-tel" type="tel" placeholder="Votre numéro" className="bg-black/50 border-white/10 text-siyajj-ivory h-14 rounded-lg focus-visible:ring-siyajj-luxury-gold/50 focus-visible:border-siyajj-luxury-gold/50 font-light text-lg" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="contact-email" className="text-[10px] uppercase tracking-widest text-siyajj-luxury-gold ml-1">Email</label>
                  <Input id="contact-email" type="email" placeholder="Votre email" className="bg-black/50 border-white/10 text-siyajj-ivory h-14 rounded-lg focus-visible:ring-siyajj-luxury-gold/50 focus-visible:border-siyajj-luxury-gold/50 font-light text-lg" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="contact-ville" className="text-[10px] uppercase tracking-widest text-siyajj-luxury-gold ml-1">Ville de résidence</label>
                  <Input id="contact-ville" placeholder="Ex: Paris" className="bg-black/50 border-white/10 text-siyajj-ivory h-14 rounded-lg focus-visible:ring-siyajj-luxury-gold/50 focus-visible:border-siyajj-luxury-gold/50 font-light text-lg" />
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-siyajj-luxury-gold ml-1">Type de voyage</label>
                  <Select>
                    <SelectTrigger aria-label="Type de voyage" className="bg-black/50 border-white/10 text-siyajj-ivory h-14 rounded-lg focus:ring-siyajj-luxury-gold/50 focus:border-siyajj-luxury-gold/50 font-light text-lg">
                ...
                <div className="space-y-2">
                  <label htmlFor="contact-periode" className="text-[10px] uppercase tracking-widest text-siyajj-luxury-gold ml-1">Période souhaitée</label>
                  <Input id="contact-periode" placeholder="Ex: Ramadan 2026, Novembre..." className="bg-black/50 border-white/10 text-siyajj-ivory h-14 rounded-lg focus-visible:ring-siyajj-luxury-gold/50 focus-visible:border-siyajj-luxury-gold/50 font-light text-lg" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="contact-message" placeholder="Indiquez vos besoins spécifiques, le niveau de confort attendu, le nombre de voyageurs..." className="bg-black/50 border-white/10 text-siyajj-ivory min-h-[150px] rounded-lg focus-visible:ring-siyajj-luxury-gold/50 focus-visible:border-siyajj-luxury-gold/50 font-light text-lg p-5" />
              </div>

              <Dialog>
                <DialogTrigger asChild>
                  <Button className="w-full h-16 bg-siyajj-luxury-gold text-siyajj-deep-black hover:bg-siyajj-champagne uppercase tracking-widest text-sm font-bold mt-6 rounded-xl sweep-hover relative overflow-hidden shadow-[0_0_30px_rgba(200,154,70,0.3)]">
                ...
                <DialogContent className="bg-siyajj-warm-black border border-siyajj-luxury-gold/30 text-center p-1 rounded-2xl backdrop-blur-2xl">
                  <div className="bg-black/60 rounded-xl p-8 text-center border border-white/5">
                    ...
                    <h3 className="font-serif text-3xl text-siyajj-champagne mb-4">Demande transmise avec succès</h3>
                    <p className="text-siyajj-ivory/80 font-light leading-relaxed mb-8">
                      La Maison SIYAJJ a bien reçu votre demande de devis. Un conseiller de notre service conciergerie vous recontactera très prochainement pour affiner votre projet d'exception.
                    </p>
                    <Button asChild variant="outline" className="border-siyajj-luxury-gold/40 text-siyajj-luxury-gold hover:bg-siyajj-luxury-gold hover:text-siyajj-deep-black w-full h-14 rounded-lg font-bold uppercase tracking-widest text-xs sweep-hover relative overflow-hidden">
                      <Link href="/">
