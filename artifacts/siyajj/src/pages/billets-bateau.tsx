...
import { ArrowRight, CheckCircle2, Phone, MessageCircle, Ship } from "lucide-react";
...
const SERVICES = [
  { title: "Traversées Méditerranée & Atlantique", desc: "Algérie, Maroc, Tunisie, Espagne — liaisons maritimes régulières." },
  { title: "Cabines économique, confort & premium", desc: "Nous sélectionnons la classe adaptée à votre confort et votre budget." },
  { title: "Groupes & familles nombreuses", desc: "Tarifs négociés pour les départs groupés et les familles." },
  { title: "Véhicules & bagages", desc: "Transport de véhicules et assistance bagages pour un voyage serein." },
  { title: "Assistance avant embarquement", desc: "Vérification des documents, conseils check-in, horaires et terminaux." },
  { title: "Combinés bateau + hôtel", desc: "Forfaits complets avec hébergement à destination sur demande." },
];

export default function BilletsBateau() {
  return (
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Billets bateau SIYAJJ Voyages"
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 pb-12 md:pb-16 pt-24">
          <motion.div {...fade(0)}>
            <OrnamentBadge className="mb-5">
              <Ship className="w-3 h-3 mr-1.5 inline-block" strokeWidth={1.4} />
              Billets Bateau
            </OrnamentBadge>
          </motion.div>

          <motion.h1 {...fade(0.1)} className="display-lg text-siyajj-ivory mb-4 max-w-2xl drop-shadow-lg">
            Votre traversée, réservée<br />
            <span className="text-gold-gradient">avec élégance.</span>
          </motion.h1>

          <motion.p {...fade(0.2)} className="body-lg text-siyajj-ivory/75 max-w-xl mb-8">
            Liaisons maritimes depuis la France et la Belgique — Algérie, Maroc, Tunisie et au-delà.
          </motion.p>
          ...
          <motion.div {...fade(0.3)} className="flex flex-col sm:flex-row gap-3">
            <Button asChild className="h-13 px-8 bg-gradient-to-r from-siyajj-antique-bronze via-siyajj-luxury-gold to-siyajj-champagne text-siyajj-deep-black hover:brightness-110 rounded-lg uppercase tracking-[0.1em] text-[11px] font-bold">
              <Link href="/contact?service=billets-bateau">
      ...
      <section className="py-20 bg-siyajj-black-ink border-t border-siyajj-luxury-gold/10">
        <div className="container mx-auto px-4 md:px-8">
          <motion.div {...fade(0)} className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="section-title text-siyajj-ivory mb-4">Un service complet de traversée</h2>
      ...
      <section className="py-16 bg-siyajj-deep-black border-t border-siyajj-luxury-gold/10">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="section-title text-siyajj-ivory mb-4">Prêt à réserver votre traversée ?</h2>
